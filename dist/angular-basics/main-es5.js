...
var AppRouterComponent = /** @class */ (function () {
...
var PostComponent = /** @class */ (function () {
    function PostComponent(route, postsService) {
        this.route = route;
    ...
    PostComponent.prototype.submitUpdate = function () {
        this.updateObj.emit(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.p, { title: this.inputValue }));
    };
...
var PostsComponent = /** @class */ (function () {
    ...
    PostsComponent.prototype.getPosts = function () {
        var _this = this;
        this.postsService.getPost().subscribe(function (posts) { return (_this.allPosts = posts); });
    };
    PostsComponent.prototype.addPost = function () {
        ...
        this.postsService
            ...
            _this.allPosts.unshift(res);
            _this.postTitle = '';
        });
    };
    PostsComponent.prototype.removePost = function (id) {
        var _this = this;
        this.postsService
            .removePost(id)
            .subscribe(function () { return (_this.allPosts = _this.allPosts.filter(function (p) { return p.id !== id; })); });
    };
    PostsComponent.prototype.updatePost = function (obj) {
        var _this = this;
        this.postsService
            .updatePost(obj)
            .subscribe(function () {
            return (_this.allPosts = _this.allPosts.map(function (p) { return (p.id === obj.id ? obj : p); }));
        });
    };
...
var PostsService = /** @class */ (function () {
    ...
    PostsService.prototype.updatePost = function (editPost) {
        return this.http.patch("https://jsonplaceholder.typicode.com/todos/" + editPost.id, editPost);
    };
    PostsService.prototype.removePost = function (id) {
